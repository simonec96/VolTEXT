...
public interface VolTextListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterTvalue(VolTextParser.TvalueContext ctx);
	/**
	 * Exit a parse tree produced by {@link VolTextParser#tvalue}.
	 * @param ctx the parse tree
	 */
	void exitTvalue(VolTextParser.TvalueContext ctx);
	/**
	 * Enter a parse tree produced by {@link VolTextParser#figure}.
	 * @param ctx the parse tree
	 */
	void enterFigure(VolTextParser.FigureContext ctx);
	/**
	 * Exit a parse tree produced by {@link VolTextParser#figure}.
	 * @param ctx the parse tree
	 */
	void exitFigure(VolTextParser.FigureContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterColorBullet(VolTextParser.ColorBulletContext ctx);
	/**
	 * Exit a parse tree produced by {@link VolTextParser#colorBullet}.
	 * @param ctx the parse tree
	 */
	void exitColorBullet(VolTextParser.ColorBulletContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterAlignment(VolTextParser.AlignmentContext ctx);
	/**
	 * Exit a parse tree produced by {@link VolTextParser#alignment}.
	 * @param ctx the parse tree
	 */
	void exitAlignment(VolTextParser.AlignmentContext ctx);
	/**
